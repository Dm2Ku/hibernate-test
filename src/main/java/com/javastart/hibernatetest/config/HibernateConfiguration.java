package com.javastart.hibernatetest.config;
...
localSessionFactoryBean.setPackagesToScan("com.javastart.hibernatetest.entity");
...
basicDataSource.setUsername(environment.getProperty("jdbc.pass"));
